...
while True:
    ...
    if employee_type not in ['government', 'private', 'contract']:
        ...
        # Breaking the loop if input is valid
        break
...
if employee_type == 'government':
    ...
    # Exiting the program if employee type is invalid
    print("Invalid employee type!")
    exit()

# Printing the employee object, showing name, income, and calculated tax
print(employee)

# Calculating and printing the tax for the employee
